    ...
    <div class="col-xs-10">
      <div class="box">
        <div class="box-header">
            <h3>Tambah Data</h3>
            <small>Menginput data user dengan hak akses admin</small>
        </div>
        <br>
        <?php 
        ...
        <form action="<?php url("addUser/") ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
                <div class="form-group">
                    <label for="nipInput">Id user</label>
                    <input type="text" class="form-control" placeholder="Masukan id user" name="id_user">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukan email sebagai username" name="username">
                </div>
                <div class="form-group">
                    <label for="passwordInput">Password</label>
                    <input type="text" class="form-control" placeholder="Masukan password default" name="password">
                </div>
            </div>
            <!-- /.box-body -->
            &nbsp
