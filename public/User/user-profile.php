...
<div class="wrapper">
  ...
  <?php 
    ...
    }else if($_SESSION['hak_akses'] == 'R'){
        $id = "nip";
        $class = "\model\Resepsionis";
        $redirect = "Resepsionis/update/";
    ...
    if($_SESSION['hak_akses'] == 'A'){
      ...
      ->ready();
    }else if($_SESSION['hak_akses'] == 'D' || $_SESSION['hak_akses'] == 'R'){
      $classs = explode('\\',$class);
      $model->select($model->getTable())->join('tb_user','tb_user.username',$model->getTable().'.email')
            ...
            <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php if($_SESSION['hak_akses'] == 'R' || $_SESSION['hak_akses'] == 'D'){ ?>
                    <tr>
                        <td>Tanggal Lahir</td>
