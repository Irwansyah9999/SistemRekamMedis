    ...
    <div class="col-xs-10">
      <div class="box">
        ...
        <?php 
            ...
            $id_dokter = $request->get(2);


            $dokter = new \model\Dokter();
            $dokter->select($dokter->getTable())->where()->comparing("id_dokter",$id_dokter)->ready();

            $row = $dokter->getStatement()->fetch();
        ...
        <form action="<?php url("updateDokter/") ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
                <div class="form-group">
                    <label for="idDokter">Id Dokter</label>
                    <input type="text" class="form-control" id="idDokter" placeholder="Masukan id" name="id_dokter" value="<?php echo $row['id_dokter'] ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="namaDokter">Nama Dokter</label>
                    <input type="text" class="form-control" id="namaDokter" name="nama_dokter" placeholder="Masukan nama" value="<?php echo $row['nama_dokter'] ?>">
                </div>
                <div class="form-group">
